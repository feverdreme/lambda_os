...
run-debug: $(IMAGE_NAME).iso
	qemu-system-x86_64 -M q35 -m 4G -cdrom $(IMAGE_NAME).iso -boot d -s -S
...
run-uefi: ovmf $(IMAGE_NAME).iso
	qemu-system-x86_64 -M q35 -m 4G -bios ovmf/OVMF.fd -cdrom $(IMAGE_NAME).iso -boot d
...
run-hdd-uefi: ovmf $(IMAGE_NAME).hdd
	qemu-system-x86_64 -M q35 -m 4G -bios ovmf/OVMF.fd -hda $(IMAGE_NAME).hdd
